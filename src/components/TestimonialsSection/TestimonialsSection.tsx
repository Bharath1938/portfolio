  ...
  const testimonials = [
    {
      ...
      role: "Brilliant Systems Solutions",
      content: "Bharathwaj demonstrated great agility across .NET, React, and SQL. His ability to build robust REST APIs, troubleshoot complex database connectivity, and ensure code maintainability has made him an invaluable engineer.",
      image: "https://images.pexels.com/photos/1516680/pexels-photo-1516680.jpeg?auto=compress&cs=tinysrgb&w=150"
    },
    {
      name: "Engineering Colleague & Mentor",
      role: "Shiash Info Solutions",
      content: "A proactive software developer who picks up new frameworks with impressive speed. His contributions to our Java modules and analytical problem-solving during testing and debugging were consistently commendable.",
      image: "https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=150"
    },
    {
      name: "Academic Project Mentor",
      role: "RVS College of Engineering & Tech",
      content: "Bharathwaj served as an outstanding Team Lead for our Swin Transformer ophthalmic diagnosis project. His diligence in data modeling, deep learning architectures, and team coordination was truly exceptional.",
    ...
    <section id="testimonials" className="max-w-7xl mx-auto px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">
          Professional <span className="text-gradient-primary">Endorsements</span>
        </h2>
        <p className="text-muted-foreground max-w-xl mx-auto">
          Feedback and peer reviews from project leads, colleagues, and academic mentors.
        </p>
      </motion.div>
