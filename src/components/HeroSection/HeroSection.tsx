    ...
    <section id="hero" className="relative min-h-[100vh] flex flex-col pt-12 md:pt-16 overflow-hidden bg-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex-1 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 pb-12">
        ...
        >
          ...
          >
            Fullstack Developer with expertise in building responsive, scalable web applications using .NET, Java, React, SQL, and modern JavaScript architectures. Passionate about performant backend APIs, intuitive user experiences, and applied machine learning.
          </motion.p>
          ...
          >
            ...
            <a
              href="tel:6369698738"
              aria-label="Phone"
              className="text-muted-foreground hover:text-primary transition-colors hover:-translate-y-1 transform duration-200 text-xs font-mono font-semibold"
            >
              +91 6369698738
            </a>
          </motion.div>
          ...
          >
            <div className="flex flex-col h-full bg-card w-full">
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                <div>
                  <h3 className="text-xl font-extrabold tracking-tight text-foreground">Bharathwaj</h3>
                ...
                <div className="grid grid-cols-2 gap-2.5 w-full text-left bg-muted/40 p-3 rounded-xl border border-border/50">
                  <div>
                    ...
                    <span className="font-bold text-foreground text-xs">.NET, React & Java</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground block text-[9px] uppercase tracking-widest font-bold">Location</span>
                    <span className="font-bold text-foreground text-xs">Tiruppur, TN</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground block text-[9px] uppercase tracking-widest font-bold">Experience</span>
                    <span className="font-bold text-foreground text-xs">Software Trainee & Dev</span>
                  </div>
                  <div>
