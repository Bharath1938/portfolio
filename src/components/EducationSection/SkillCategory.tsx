...
export default function ProfessionalProfile() {
  const technicalSkills = [
    { name: ".NET / ASP.NET & C#", level: 92, icon: Server, color: "text-purple-400" },
    { name: "React.js & JavaScript", level: 90, icon: Atom, color: "text-cyan-400" },
    { name: "Java & REST API Integration", level: 88, icon: Code2, color: "text-blue-400" },
    { name: "SQL & Database Management", level: 89, icon: Database, color: "text-amber-400" },
    { name: "Entity Framework & Backend Services", level: 86, icon: Workflow, color: "text-emerald-400" },
    { name: "Python & Machine Learning (LSTM, Vision)", level: 85, icon: Brain, color: "text-rose-400" },
  ];

  const softSkills = [
    { name: "Problem Solving", icon: Brain, color: "text-purple-400 border-purple-500/30 bg-purple-500/10" },
    { name: "Analytical Thinking", icon: Lightbulb, color: "text-amber-400 border-amber-500/30 bg-amber-500/10" },
    { name: "Critical Thinking", icon: Workflow, color: "text-sky-400 border-sky-500/30 bg-sky-500/10" },
    { name: "Time Management", icon: HeartHandshake, color: "text-rose-400 border-rose-500/30 bg-rose-500/10" },
    { name: "Team Leadership", icon: Crown, color: "text-yellow-400 border-yellow-500/30 bg-yellow-500/10" },
          ...
          <div>
            ...
            <div className="mt-6 pt-4 border-t border-border/40">
              ...
              <div className="flex gap-2.5">
                <span className="px-3 py-1.5 rounded-xl border border-primary/20 bg-primary/5 text-xs font-semibold text-foreground">
                  English <span className="text-primary font-bold">(Fluent)</span>
                </span>
                <span className="px-3 py-1.5 rounded-xl border border-primary/20 bg-primary/5 text-xs font-semibold text-foreground">
                  Tamil <span className="text-primary font-bold">(Native)</span>
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-primary/10 via-purple-500/5 to-transparent border border-primary/20 flex items-start gap-3.5 shadow-sm">
              ...
              <div>
                <strong className="text-foreground font-bold text-sm block mb-0.5">
                  Adaptable Engineer & Fast Learner
                </strong>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Strong analytical problem-solver with a proven ability to learn, adapt to new stacks, and deliver production-ready code in .NET, Java, and React.
                </p>
              </div>
            </div>
          </div>
